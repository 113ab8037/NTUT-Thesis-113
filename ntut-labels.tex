...
\newcommand\cTitle{使用生成式AI導入邊緣運算裝置的測試與服務}
...
\newcommand\eTitle{Introducing testing and services for edge computing devices using generative AI}
